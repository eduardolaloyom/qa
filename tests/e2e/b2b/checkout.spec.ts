...
test.describe('C2 — Checkout / crear pedido', () => {
  ...
  test('C2-11: Flujo completo catalogo → carro → checkout', async ({ authedPage: page }) => {
    ...
    await page.screenshot({ path: 'test-results/checkout-confirm.png', fullPage: true });
  ...
  test('C2-12: Doble click en crear pedido no genera duplicado', async ({ authedPage: page }) => {
    await addProductsToCart(page);
  ...
  test('C2-13: Pedido aparece en historial', async ({ authedPage: page }) => {
